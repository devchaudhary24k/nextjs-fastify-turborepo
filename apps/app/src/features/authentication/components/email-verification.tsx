...
import { checkEmailVerification } from "../api/check-email-verification";
  ...
  return (
    <Card className="relative z-10 mx-auto w-full max-w-md border shadow-2xl backdrop-blur-sm">
      <CardHeader className="space-y-4 text-center">
        ...
        <div className="bg-white/8 relative mx-auto flex h-16 w-16 items-center justify-center rounded-full">
